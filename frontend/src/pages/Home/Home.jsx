...
const Home = () => {
  ...
  return (
    <div>
      {/* top */}
      <div className="flex flex-col gap-6 py-28 px-3 max-w-[105rem] mx-auto">
        ...
        <div className="text-gray-400 text-xs sm:text-sm">
          Subrata Estate will help you find your dream home fast, easy and
          confortable.
          <br />
      ...
      <div className="max-w-[110rem] mx-auto p-3 flex flex-col gap-8 my-10">
